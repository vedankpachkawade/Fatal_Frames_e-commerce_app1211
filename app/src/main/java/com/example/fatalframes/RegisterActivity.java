...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText InputName, InputPhoneNumber, InputPassword, InputMailid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputMailid = (EditText) findViewById(R.id.register_mail_input);
    ...
    private void CreateAccount() {
        ...
        String mailid = InputMailid.getText().toString();
        ...
        if (TextUtils.isEmpty(name)){
            ...
            validatephoneNumber(name, phone, password, mailid);

        }
    }

    private void validatephoneNumber(String name, String phone, String password, String mailid) {
